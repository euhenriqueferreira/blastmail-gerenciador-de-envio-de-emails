...
<button {{ $attributes
        ...
        ->class([
           ...
           'bg-white dark:bg-gray-800 border-red-300 dark:border-red-500 text-red-700 dark:text-red-300 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 focus:ring-red-500 disabled:opacity-25'=> $danger
        ])
    }}>
    {{ $slot }}
</button>
